...
WebUI.setText(findTestObject('Object Repository/Page_Axis Bank Credit Card/input_Pincode_cust_PINCODE'), '000000')
...
WebUI.verifyElementVisible(findTestObject('Page_Axis Bank Credit Card/button_Ok'))
