...
WebUI.click(findTestObject('Object Repository/Page_Axis Bank Credit Card/label_I agree to terms and conditions of OTP'))

WebUI.click(findTestObject('Object Repository/Page_Axis Bank Credit Card/button_I agree'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_Axis Bank Credit Card/button_Next_1'))
